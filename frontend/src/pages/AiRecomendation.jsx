...
const AiRecomendation = () => {
  return (
    <div className="w-full min-h-screen bg-gradient-to-b from-[#181818] via-[#232323] to-[#181818] flex items-center justify-center overflow-hidden relative">
      <img src="/bg_banner.jpg" className="absolute inset-0 w-full h-full object-cover opacity-20 blur-[2px]" />
        ...
        <div className="flex flex-col items-center flex-1 gap-4 w-full">
          <div className="flex-1 mb-6 w-full">
            ...
            <div className="flex justify-between items-center mt-6 w-full">
              <button
                type="button"
                className="py-2 px-6 bg-[#181818] text-white font-semibold rounded-lg hover:bg-[#232323] border-2 border-[#444444] transition-colors duration-300 cursor-pointer"
              >
                Back
              </button>
              <button
                type="button"
                className="py-2 px-6 bg-[#e50914] text-white font-semibold rounded-lg hover:bg-[#f40612] border-2 border-[#e50914] transition-colors duration-300 cursor-pointer"
              >
                Next
              </button>
            </div>
